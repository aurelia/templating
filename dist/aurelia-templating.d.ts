...
export declare interface bindable {
   ...
   */
  (nameOrConfigOrTarget?: string | Object | BindablePropertyConfig, key?: any, descriptor?: any): any
   ...
   */
  usePropertyType(shouldUsePropertyType: boolean): void
  /**
   * @param nameOrConfigOrTarget The name of the property, or a configuration object.
   */
 ...
 */
export declare function createTypedBindable(name: string): (nameOrConfigOrTarget?: string | BindablePropertyConfig, key?: string, descriptor?: PropertyDescriptor) => bindable;
