System.register([], function (_export) {
  ...
  var noMutations, Children, ChildBinder;
  return {
    setters: [],
    execute: function () {
      noMutations = [];
      Children = function Children(property, changeHandler, selector) {
      ...
      ChildBinder = function ChildBinder(selector, target, property, behavior, changeHandler) {
        this.selector = selector;
        this.target = target;
        this.property = property;
        this.target = target;
