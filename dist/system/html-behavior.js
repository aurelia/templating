System.register(["aurelia-metadata", "aurelia-binding", "aurelia-task-queue", "./view-strategy", "./view-engine", "./content-selector", "./util", "./bindable-property", "./behavior-instance"], function (_export) {
  var Metadata, Origin, ResourceType, ObserverLocator, TaskQueue, ViewStrategy, ViewEngine, ContentSelector, hyphenate, BindableProperty, BehaviorInstance, _prototypeProperties, _inherits, _classCallCheck, defaultInstruction, contentSelectorFactoryOptions, hasShadowDOM, HtmlBehaviorResource;
  ...
  return {
    ...
    execute: function () {
      ...
      HtmlBehaviorResource = _export("HtmlBehaviorResource", (function (ResourceType) {
