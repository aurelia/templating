System.register(["aurelia-dependency-injection", "./view", "./view-slot", "./content-selector", "./resource-registry"], function (_export) {
  ...
  var Container, View, ViewSlot, ContentSelector, ViewResources, _inherits, BehaviorContainer, BoundViewFactory, defaultFactoryOptions, ViewFactory;
  ...
  return {
    ...
    execute: function () {
      ...
      BoundViewFactory = function BoundViewFactory(parentContainer, viewFactory, executionContext) {
      ...
      ViewFactory = function ViewFactory(template, instructions, resources) {
