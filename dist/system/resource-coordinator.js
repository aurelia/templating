System.register(["aurelia-loader", "aurelia-dependency-injection", "aurelia-metadata", "aurelia-binding", "./custom-element", "./attached-behavior", "./template-controller", "./view-engine"], function (_export) {
  ...
  var Loader, Container, getAnnotation, addAnnotation, ResourceType, Origin, ValueConverter, CustomElement, AttachedBehavior, TemplateController, ViewEngine, id, ResourceCoordinator, ResourceModule;
  ...
  return {
    ...
    execute: function () {
      id = 0;
      ResourceCoordinator = function ResourceCoordinator(loader, container, viewEngine) {
        this.loader = loader;
      ...
      ResourceModule = function ResourceModule(source, element, resources) {
        var i, ii;
