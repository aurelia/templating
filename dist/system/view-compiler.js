System.register(["./resource-registry", "./view-factory", "./binding-language"], function (_export) {
  ...
  var ResourceRegistry, ViewFactory, BindingLanguage, nextInjectorId, defaultCompileOptions, hasShadowDOM, ViewCompiler;
  ...
  return {
    ...
    execute: function () {
      ...
      ViewCompiler = function ViewCompiler(bindingLanguage) {
      ...
      ViewCompiler.prototype.compile = function (templateOrFragment, resources) {
        var _this = this;
