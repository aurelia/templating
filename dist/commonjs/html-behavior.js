...
var _Metadata$Origin$ResourceType = require('aurelia-metadata');
    ...
    value: function load(container, target, viewStrategy, transientView) {
      ...
      if (this.elementName !== null) {
        ...
        if (!viewStrategy.moduleId) {
          viewStrategy.moduleId = _Metadata$Origin$ResourceType.Origin.get(target).moduleId;
        }
...
})(_Metadata$Origin$ResourceType.ResourceType);
