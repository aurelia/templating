...
## [Named Slots](aurelia-doc://section/7/version/1.0.0)
...
## [Fallback Slots](aurelia-doc://section/8/version/1.0.0)
...
## [Slot Implementation Limitations](aurelia-doc://section/9/version/1.0.0)

At the time this document was written, no browser supports Shadow DOM v1 slots. Thus, Aurelia has implemented the specification. It also works with *template controllers* such as `if` and `repeat` which can dynamically generate content. We've fixed up our `@child` and `@children` decorators to understand the new model as well.
...
## [Decorators for Customizing Aurelia Custom Element Processing](aurelia-doc://section/10/version/1.0.0)
